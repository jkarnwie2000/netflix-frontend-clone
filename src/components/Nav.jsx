    ...
    return (
        ...
        <div className="px-30 py-5 bg-black text-white z-10">
            ...
            <div className="py-30 flex flex-col items-center">
                ...
                <div className="py-5 font-bold text-[18px]">Starts at NOK 99. Cancel at any time.</div>
                <p>Ready to watch? Enter your email to create or restart your membership.</p>
                <div className="py-5">
                    <input className="border p-2 border-gray-500 pr-30 mr-5" type="text" placeholder="Email Address" />
                    <button className="bg-red-600 font-bold p-2 px-5 rounded">Get Started</button>
                </div>
            </div>
            </div>       
        </div>        
